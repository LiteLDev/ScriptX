    ...
    namespace py_backend {
        ...
        void EngineLockerHelper::waitToEnterEngine() {
            ...
            if (EngineLockerHelper::allPyEnginesEnterCount == 0) {
                ...
                PyThreadState *mainThreadState = PyEngine::mainThreadStateInTLS_.get();
                if (mainThreadState == NULL) {
                    ...
                    mainThreadState = PyThreadState_New(PyEngine::mainInterpreterState_);
                    // Save to TLS storage
                    PyEngine::mainThreadStateInTLS_.set(mainThreadState);
        ...
        void EngineLockerHelper::finishExitEngine() {
            ...
            if (EngineLockerHelper::allPyEnginesEnterCount == 0) {
                ...
                PyEngine::mainThreadStateInTLS_.set(PyEval_SaveThread());
            }
            engineLocker.unlock();
        }
        ...
        void EngineLockerHelper::startDestroyEngine() {
            ...
            if (EngineLockerHelper::allPyEnginesEnterCount == 0) {
                ...
                PyEval_RestoreThread(PyEngine::mainThreadStateInTLS_.get());
            }
        }
